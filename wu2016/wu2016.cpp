...
int main()
{
	...
	double sum = 0;
	for (int j = 0; j < 5; j++) {
		cout << "the time of running wu2016 " << times[j] << " times is :: " << endl;
...
void userRegistrationTime(Gateway gateWay) {
	...
	for (int j = 0; j < 5; j++) {
		cout << "User registration time of running wu2016 " << times[j] << " times is :: " << endl;
		for (int k = 0; k < count; k++) {
			for (int i = 0; i < times[j]; i++) {
				clock1 = clock();
...
void sensorRegistrationTime(Gateway gateWay) {
	...
	for (int j = 0; j < 5; j++) {
		cout << "Sensor registration time of running wu2016 " << times[j] << " times is :: " << endl;
		for (int k = 0; k < count; k++) {
			for (int i = 0; i < times[j]; i++) {
				clock1 = clock();
